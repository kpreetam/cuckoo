...
class BitByteClockView @JvmOverloads constructor(
    ...
    private val paintOn = Paint(Paint.ANTI_ALIAS_FLAG).apply { style = Paint.Style.FILL }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val labelColW = w * 0.10f
        val dotAreaW = (w - labelColW) / cols
        ...
        canvas.drawText(":", labelColW + dotAreaW * 2, decY, paintDecimal)
        canvas.drawText(":", labelColW + dotAreaW * 4, decY, paintDecimal)
    }
